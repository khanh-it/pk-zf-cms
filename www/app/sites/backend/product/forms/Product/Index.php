 ...
 * @author khanh-it
 */
class Product_Form_Product_Index extends Twitter_Bootstrap3_Form_Inline
{
    /**
     * (non-PHPdoc)
     * @see Zend_Form::init()
    ...
    public function init()
    {
        ...
        $elements[] = $element = $this->createElement('select', 'active', array(
            ...
            'addon_prepend' => $txt,
            'class' => 'form-control input-sm',
            'multiOptions' => array('' => $view->translate('- Chọn -')) + Product_Model_DbTable_Row_Product::returnBitStats(),
            'order' => ($eleOrder += 100),
        ));
